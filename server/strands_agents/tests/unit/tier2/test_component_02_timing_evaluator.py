"""Tier-2 atomic-robustness eval for component 02 (timing-evaluator).

Timing evaluator — flags drifts correctly, doesn't silently accept overflow or hard-reject marginal cases.
