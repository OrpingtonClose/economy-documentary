"""Tier-2 atomic-robustness eval for component 08 (coherence-evaluator).

Coherence evaluator critiques — cite specific elements, calibrated ratings, suggested edits only when needed.
