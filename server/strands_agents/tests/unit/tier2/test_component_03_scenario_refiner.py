"""Tier-2 atomic-robustness eval for component 03 (scenario-refiner).

Scenario refiner — adjusts flagged scenes by reported drift, preserves on-topic content and style lock.
