"""Tier-2 atomic-robustness eval for component 13 (escalation-supervisor).

Escalation supervisor — warranted only when retry+fix budgets exhausted, target matches failure class.
