"""Tier-2 atomic-robustness eval for component 09 (visual-loop).

Visual-loop trajectory — feeds critiques into next concept revision, converges or escalates within budget.
