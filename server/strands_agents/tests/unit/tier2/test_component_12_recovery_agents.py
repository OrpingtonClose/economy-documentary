"""Tier-2 atomic-robustness eval for component 12 (recovery-agents).

Recovery agents — climb the ladder in order: transient→retry, deterministic→fix, persistent→escalate.
