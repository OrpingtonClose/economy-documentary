"""Tier-2 atomic-robustness eval for component 04 (audio-agent).

Audio agent metadata records — accept records whose measurements honour the LUFS / clipping / hiss invariants.
