"""Tier-2 atomic-robustness eval for component 14 (pipeline-graph).

Pipeline-graph orchestrator — respects stable pipeline shape, parallelises per-scene, sequences dependent stages.
