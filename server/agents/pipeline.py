...
def _init_pipeline_state(
    ...
    # overwrite to "" (not None) to clear any stale critique from a
    # prior run — the scenario generator's instruction template
    # interpolates ``{_intent_gate_critique}`` and ADK's resolver would
    # render ``None`` as the literal string "None", confusing the LLM
    # into thinking "None" was an actual critique.
