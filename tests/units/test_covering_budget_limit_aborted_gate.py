...
from effects import PipelineStarted, BudgetSet, VMAllocated, PipelineAborted

def test_covering_budget_limit_aborted_gate():
    print('\n▶️  [STARTING TEST] test_covering_budget_limit_aborted_gate')
    ...
    with IntegrationHarness(required_agents=["gsa"]) as harness:
        ...
        print('    ✓ budget limit aborted gate passed')
