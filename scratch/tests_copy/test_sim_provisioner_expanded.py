...
def test_sim_provisioner_allocation_success():
...
def test_sim_provisioner_allocation_out_of_budget():
...
def test_sim_provisioner_escalation_triggers():
...
def test_sim_provisioner_preemption_recovery():
...
def test_sim_provisioner_deallocation_reasons():
...
def test_sim_provisioner_ssh_handshake_timeout():
...
def test_sim_provisioner_vast_offers_parsing():
...
def test_sim_provisioner_multiple_instance_types():
...
def test_sim_provisioner_allocation_retry_backoff():
...
def test_sim_provisioner_deallocated_state_sync():
...
def test_sim_provisioner_billing_projection():
...
def test_sim_provisioner_cost_accumulation():
...
def test_sim_provisioner_vm_heartbeat_monitoring():
...
def test_sim_provisioner_vast_connection_failure():
...
def test_sim_provisioner_escalation_limit():
...
def test_sim_provisioner_gpu_offer_filtering():
...
def test_sim_provisioner_provision_failure_cleanup():
...
def test_sim_provisioner_zombie_vm_cleanup():
...
def test_sim_provisioner_worker_scale_down():
...
def test_sim_provisioner_worker_scale_up():
...
def test_sim_provisioner_instance_state_polling():
...
def test_sim_provisioner_api_key_rotation():
...
def test_sim_provisioner_concurrent_vm_requests():
...
def test_sim_provisioner_invalid_offer_skipping():
...
def test_sim_provisioner_vast_cli_error_handling():
...
def test_sim_provisioner_health_status_change():
...
def test_sim_provisioner_excessive_cost_abort():
...
def test_sim_provisioner_empty_offers_fallback():
...
def test_sim_provisioner_fleet_teardown_cost_tracking():
...
def test_sim_provisioner_vm_role_transitions():
...
def test_sim_provisioner_budget_gate_verification():
...
def test_sim_provisioner_vast_api_retry_behavior():
