...
Fully AI-generated documentaries about the global economy and geopolitics, produced using open-source models on rented GPU infrastructure. Every frame of video and every word of narration was generated by AI — no stock footage, no human voice actors, no commercial APIs.
...
| Property | Value |
|----------|-------|
| **V7 (current)** | War Economy — The Real Cost |
| Duration | 76.2 minutes (26 scenes) |
| Resolution | 768×512, 24fps |
| Codec | H.264 video, AAC audio 192kbps |
| Total clips | 912 unique (no looping) |
| Final file | ~570 MB |
| B2 URL | `https://f004.backblazeb2.com/file/economy-vid-assets/v7_war_economy/FINAL_war_economy_v2.mp4` |
| | |
| **V5 (legacy)** | Economy 2025 Documentary |
